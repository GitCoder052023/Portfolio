  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20 pb-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          Full-Stack Developer crafting end-to-end solutions • Building <span className="text-[#37352f] font-semibold">Exam Bazar</span>, a transformative academic ecosystem • 6+ years of turning ideas into reality
        </motion.p>
